    ...
    public class ShadowsocksController
    {
        ...
        public ShadowsocksController()
        {
            ...
            foreach (var server in _config.configs)
                ...
                {
                    var log = new ServerSpeedLog(((ServerTrans) _transfer.servers[server.server]).totalUploadBytes,
                        ((ServerTrans) _transfer.servers[server.server]).totalDownloadBytes);
        ...
        public void ReloadIPRange()
        {
            ...
            _rangeSet.LoadChn();
            if (_config.proxyRuleMode == (int) ProxyRuleMode.BypassLanAndNotChina) _rangeSet.Reverse();
        }
        ...
        public List<Server> MergeConfiguration(Configuration mergeConfig, List<Server> servers)
        {
            ...
            for (var i = 0; i < mergeConfig.configs.Count; ++i)
            {
                ...
                if (j == -1) missingServers.Add(mergeConfig.configs[i]);
            }
        ...
        public Configuration MergeGetConfiguration(Configuration mergeConfig)
        {
            ...
            if (mergeConfig != null) MergeConfiguration(mergeConfig, ret.configs);
            return ret;
        }
        ...
        public void SaveServersConfig(Configuration config)
        {
            ...
            foreach (var s in missingServers) s.GetConnections().CloseAll();
        ...
        public bool AddServerBySSURL(string ssURL, string force_group = null, bool toLast = false)
        {
            if (ssURL.StartsWith("ss://", StringComparison.OrdinalIgnoreCase) ||
                ssURL.StartsWith("ssr://", StringComparison.OrdinalIgnoreCase))
                try
                {
        ...
        public void ToggleMode(ProxyMode mode)
        {
            ...
            SaveConfig(_config);
            if (ToggleModeChanged != null) ToggleModeChanged(this, new EventArgs());
        }
        ...
        public void ToggleRuleMode(int mode)
        {
            ...
            SaveConfig(_config);
            if (ToggleRuleModeChanged != null) ToggleRuleModeChanged(this, new EventArgs());
        }
        ...
        public void TouchPACFile()
        {
            ...
            if (PACFileReadyToOpen != null) PACFileReadyToOpen(this, new PathEventArgs {Path = pacFilename});
        }
        ...
        {
            if (gfwListUpdater != null) gfwListUpdater.UpdatePACFromGFWList(_config);
        }
        ...
        {
            if (ShowConfigFormEvent != null) ShowConfigFormEvent(index, new EventArgs());
        }
