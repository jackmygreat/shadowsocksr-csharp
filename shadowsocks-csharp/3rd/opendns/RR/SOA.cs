...
namespace OpenDNS
{
	...
	public class SOA : ResourceRecord
    {
        ...
        public SOA(string _Name, Types _Type, Classes _Class, int _TimeToLive, string _Server, string _Email,
            long _Serial, long _Refresh, long _Retry, long _Expire, long _Minimum) : base(_Name, _Type, _Class,
            _TimeToLive)
        {
            Server = _Server;
            Email = _Email;
