...
#if WindowsCE
         var data =
 bitmap.LockBits(new Rectangle(0, 0, width, height), ImageLockMode.ReadOnly, PixelFormat.Format24bppRgb);
#else
                ...
                if (pixelWidth > 4)
                {
                    ...
                    for (var y = 0; y < height; y++)
                    {
                        ...
                        for (var x = 0; x < width; x++)
                        {
                            ...
                            luminances[offset + x] =
                                (byte) ((RChannelWeight * c.R + GChannelWeight * c.G + BChannelWeight * c.B) >>
                                        ChannelWeight);
                        }
                    }
                }
                  ...
                  ptrInBitmap = IntPtr.Add(ptrInBitmap, strideStep);
                        ...
                        switch (pixelWidth)
                        {
                            ...
                            case 0:
                                ...
                                break;
                            case 1:
                                for (var x = 0; x < width; x++) luminances[offset + x] = luminancePalette[buffer[x]];
                                break;
#endif
                            case 2:
                                // should be RGB565 or RGB555, assume RGB565
                            {
                                ...
                                for (var index = 0; index < maxIndex; index += 2)
                                {
                                    ...
                                    luminances[offset] =
                                        (byte) ((RChannelWeight * r8 + GChannelWeight * g8 + BChannelWeight * b8) >>
                                                ChannelWeight);
                                    offset++;
                                }
                            }
