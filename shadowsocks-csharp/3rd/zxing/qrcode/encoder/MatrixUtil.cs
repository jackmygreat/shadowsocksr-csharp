   ...
   public static class MatrixUtil
    {
        ...
        /// <param name="matrix">The matrix.</param>
        public static void buildMatrix(BitArray dataBits, ErrorCorrectionLevel ecLevel, Version version,
            ...
            while (x > 0)
            {
                ...
                while (y >= 0 && y < matrix.Height)
                {
                    for (var i = 0; i < 2; ++i)
                    {
                        ...
                        if (!isEmpty(matrix[xx, y])) continue;
                        int bit;
        ...
        private static void embedTimingPatterns(ByteMatrix matrix)
        {
            ...
            for (var i = 8; i < matrix.Width - 8; ++i)
            {
                var bit = (i + 1) % 2;
                // Horizontal line.
                if (isEmpty(matrix[i, 6])) matrix[i, 6] = bit;
                // Vertical line.
        ...
        {
            if (matrix[8, matrix.Height - 8] == 0) throw new WriterException();
        ...
        private static void embedHorizontalSeparationPattern(int xStart, int yStart, ByteMatrix matrix)
        {
            for (var x = 0; x < 8; ++x)
            {
                if (!isEmpty(matrix[xStart + x, yStart])) throw new WriterException();
        ...
        private static void embedVerticalSeparationPattern(int xStart, int yStart, ByteMatrix matrix)
        {
            for (var y = 0; y < 7; ++y)
            {
                if (!isEmpty(matrix[xStart, yStart + y])) throw new WriterException();
