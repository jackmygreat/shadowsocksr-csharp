   ...
   public sealed class Version
    {
       ...
       private static readonly int[] VERSION_DECODE_INFO =
        ...
        private Version(int versionNumber, int[] alignmentPatternCenters, params ECBlocks[] ecBlocks)
        {
            ...
            foreach (var ecBlock in ecbArray) total += ecBlock.Count * (ecBlock.DataCodewords + ecCodewords);
        ...
        {
            if (versionNumber < 1 || versionNumber > 40) throw new ArgumentException();
            ...
            return new[]
            {
                ...
                new Version(10, new[] {6, 28, 50},
                    ...
                    new ECBlocks(28, new ECB(6, 15),
                        new ECB(2, 16))),
                new Version(11, new[] {6, 30, 54}, new ECBlocks(20, new ECB(4, 81)),
                    new ECBlocks(30, new ECB(1, 50), new ECB(4, 51)), new ECBlocks(28, new ECB(4, 22), new ECB(4, 23)),
                    new ECBlocks(24, new ECB(3, 12), new ECB(8, 13))),
                new Version(12, new[] {6, 32, 58}, new ECBlocks(24, new ECB(2, 92), new ECB(2, 93)),
                    new ECBlocks(22, new ECB(6, 36), new ECB(2, 37)), new ECBlocks(26, new ECB(4, 20), new ECB(6, 21)),
                    new ECBlocks(28, new ECB(7, 14), new ECB(4, 15))),
                new Version(13, new[] {6, 34, 62}, new ECBlocks(26, new ECB(4, 107)),
                    new ECBlocks(22, new ECB(8, 37), new ECB(1, 38)), new ECBlocks(24, new ECB(8, 20), new ECB(4, 21)),
                    new ECBlocks(22, new ECB(12, 11), new ECB(4, 12))),
                new Version(14, new[] {6, 26, 46, 66}, new ECBlocks(30, new ECB(3, 115), new ECB(1, 116)),
                    new ECBlocks(24, new ECB(4, 40), new ECB(5, 41)), new ECBlocks(20, new ECB(11, 16), new ECB(5, 17)),
                    new ECBlocks(24, new ECB(11, 12), new ECB(5, 13))),
                new Version(15, new[] {6, 26, 48, 70}, new ECBlocks(22, new ECB(5, 87), new ECB(1, 88)),
                    new ECBlocks(24, new ECB(5, 41), new ECB(5, 42)), new ECBlocks(30, new ECB(5, 24), new ECB(7, 25)),
                    new ECBlocks(24, new ECB(11, 12), new ECB(7, 13))),
                new Version(16, new[] {6, 26, 50, 74}, new ECBlocks(24, new ECB(5, 98), new ECB(1, 99)),
                    new ECBlocks(28, new ECB(7, 45), new ECB(3, 46)), new ECBlocks(24, new ECB(15, 19), new ECB(2, 20)),
                    new ECBlocks(30, new ECB(3, 15), new ECB(13, 16))),
                new Version(17, new[] {6, 30, 54, 78}, new ECBlocks(28, new ECB(1, 107), new ECB(5, 108)),
                ...
                new Version(18, new[] {6, 30, 56, 82}, new ECBlocks(30, new ECB(5, 120), new ECB(1, 121)),
                    new ECBlocks(26, new ECB(9, 43), new ECB(4, 44)), new ECBlocks(28, new ECB(17, 22), new ECB(1, 23)),
                ...
                new Version(20, new[] {6, 34, 62, 90}, new ECBlocks(28, new ECB(3, 107), new ECB(5, 108)),
                ...
                new Version(21, new[] {6, 28, 50, 72, 94}, new ECBlocks(28, new ECB(4, 116), new ECB(4, 117)),
                    new ECBlocks(26, new ECB(17, 42)), new ECBlocks(28, new ECB(17, 22), new ECB(6, 23)),
                    new ECBlocks(30, new ECB(19, 16), new ECB(6, 17))),
                new Version(22, new[] {6, 26, 50, 74, 98}, new ECBlocks(28, new ECB(2, 111), new ECB(7, 112)),
                    new ECBlocks(28, new ECB(17, 46)), new ECBlocks(30, new ECB(7, 24), new ECB(16, 25)),
                    new ECBlocks(24, new ECB(34, 13))),
                new Version(23, new[] {6, 30, 54, 74, 102}, new ECBlocks(30, new ECB(4, 121), new ECB(5, 122)),
                ...
                new Version(24, new[] {6, 28, 54, 80, 106}, new ECBlocks(30, new ECB(6, 117), new ECB(4, 118)),
                ...
                new Version(25, new[] {6, 32, 58, 84, 110}, new ECBlocks(26, new ECB(8, 106), new ECB(4, 107)),
                ...
                new Version(26, new[] {6, 30, 58, 86, 114}, new ECBlocks(28, new ECB(10, 114), new ECB(2, 115)),
                ...
                new Version(27, new[] {6, 34, 62, 90, 118},
                    ...
                    new ECBlocks(30, new ECB(8, 23), new ECB(26, 24)), new ECBlocks(30, new ECB(12, 15),
                        new ECB(28, 16))),
                new Version(28, new[] {6, 26, 50, 74, 98, 122}, new ECBlocks(30, new ECB(3, 117), new ECB(10, 118)),
                ...
                new Version(29, new[] {6, 30, 54, 78, 102, 126}, new ECBlocks(30, new ECB(7, 116), new ECB(7, 117)),
                ...
                new Version(30, new[] {6, 26, 52, 78, 104, 130}, new ECBlocks(30, new ECB(5, 115), new ECB(10, 116)),
                ...
                new Version(31, new[] {6, 30, 56, 82, 108, 134}, new ECBlocks(30, new ECB(13, 115), new ECB(3, 116)),
                ...
                new Version(32, new[] {6, 34, 60, 86, 112, 138}, new ECBlocks(30, new ECB(17, 115)),
                ...
                new Version(33, new[] {6, 30, 58, 86, 114, 142}, new ECBlocks(30, new ECB(17, 115), new ECB(1, 116)),
                ...
                new Version(34, new[] {6, 34, 62, 90, 118, 146}, new ECBlocks(30, new ECB(13, 115), new ECB(6, 116)),
                ...
                new Version(35,
                    new[] {6, 30, 54, 78, 102, 126, 150}, new ECBlocks(30, new ECB(12, 121), new ECB(7, 122)),
        ...
        public sealed class ECBlocks
        {
            ...
            public int NumBlocks
            {
                ...
                {
                    var total = 0;
                    foreach (var ecBlock in ecBlocks) total += ecBlock.Count;
                    return total;
                }
            }
