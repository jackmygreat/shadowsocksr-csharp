   ...
   public sealed class Decoder
    {
        ...
        private DecoderResult decode(BitMatrixParser parser, IDictionary<DecodeHintType, object> hints)
        {
            ...
            var totalBytes = 0;
            foreach (var dataBlock in dataBlocks) totalBytes += dataBlock.NumDataCodewords;
        ...
        private bool correctErrors(byte[] codewordBytes, int numDataCodewords)
        {
            ...
            for (var i = 0; i < numCodewords; i++) codewordsInts[i] = codewordBytes[i] & 0xFF;
            ...
            for (var i = 0; i < numDataCodewords; i++) codewordBytes[i] = (byte) codewordsInts[i];
