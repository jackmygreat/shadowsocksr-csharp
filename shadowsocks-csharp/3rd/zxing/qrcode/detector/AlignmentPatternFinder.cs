   ...
   internal sealed class AlignmentPatternFinder
    {
        ...
        /// </param>
        internal AlignmentPatternFinder(BitMatrix image, int startX, int startY, int width, int height,
        ...
        internal AlignmentPattern find()
        {
            ...
            if (possibleCenters.Count != 0) return possibleCenters[0];
