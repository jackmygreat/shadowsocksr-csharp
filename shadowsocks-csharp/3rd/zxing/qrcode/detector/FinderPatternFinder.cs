   ...
   public class FinderPatternFinder
    {
        ...
        private bool crossCheckDiagonal(int startI, int centerJ, int maxCount, int originalStateCountTotal)
        {
            ...
            if (startI - i < 0 || centerJ - i < 0) return false;
            ...
            if (startI - i < 0 || centerJ - i < 0 || stateCount[1] > maxCount) return false;
        ...
        private float? crossCheckVertical(int startI, int centerJ, int maxCount, int originalStateCountTotal)
        {
            ...
            // the original, assume it's a false positive
            var stateCountTotal = stateCount[0] + stateCount[1] + stateCount[2] + stateCount[3] + stateCount[4];
            if (5 * Math.Abs(stateCountTotal - originalStateCountTotal) >= 2 * originalStateCountTotal) return null;
        ...
        private float? crossCheckHorizontal(int startJ, int centerI, int maxCount, int originalStateCountTotal)
        {
            ...
            // the original, assume it's a false positive
            var stateCountTotal = stateCount[0] + stateCount[1] + stateCount[2] + stateCount[3] + stateCount[4];
            if (5 * Math.Abs(stateCountTotal - originalStateCountTotal) >= originalStateCountTotal) return null;
            ...
            if (centerI != null)
            {
                    ...
                    (!pureBarcode || crossCheckDiagonal((int) centerI, (int) centerJ, stateCount[2], stateCountTotal)))
                {
                    ...
                    if (!found)
                    {
                        ...
                        if (resultPointCallback != null) resultPointCallback(point);
                    }
        ...
        private FinderPattern[] selectBestPatterns()
        {
            ...
            if (possibleCenters.Count > 3)
            {
                ...
                var totalModuleSize = 0.0f;
                foreach (var possibleCenter in possibleCenters) totalModuleSize += possibleCenter.EstimatedModuleSize;
