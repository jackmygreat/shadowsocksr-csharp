      ...
      private const String PLATFORM_DEFAULT_ENCODING = "UTF-8";
        ...
        public static string guessEncoding(byte[] bytes, IDictionary<DecodeHintType, object> hints)
        {
            if (hints != null && hints.ContainsKey(DecodeHintType.CHARACTER_SET))
            {
                ...
                if (characterSet != null) return characterSet;
            }
            ...
            if (canBeUTF8 && (utf8bom || utf2BytesChars + utf3BytesChars + utf4BytesChars > 0)) return UTF8;
            ...
            if (canBeISO88591) return ISO88591;
            if (canBeShiftJIS) return SHIFT_JIS;
            if (canBeUTF8) return UTF8;
